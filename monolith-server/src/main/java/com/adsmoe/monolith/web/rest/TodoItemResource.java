...
public class TodoItemResource {
    ...
    @Timed
    public ResponseEntity<List<TodoItem>> getAllTodoItems(@ApiParam Pageable pageable) {
        log.debug("REST request to get a page of TodoItems");
        Page<TodoItem> page = todoItemService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/todo-items");
    ...
    public ResponseEntity<TodoItem> getTodoItem(@PathVariable Long id) {
        ...
        TodoItem todoItem = todoItemService.findOne(id);
